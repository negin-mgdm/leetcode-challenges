...
class Solution(object):
    def countStudents(self, students, sandwiches):
        ...
        while students:  # Checking whether the list students is not empty.
            if students[0] == sandwiches[0]:
                ...
                # Increment the counter since the sandwich wasn't taken.
                count += 1

            # If all students have passed on the sandwich.
